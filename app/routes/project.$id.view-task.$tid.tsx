                    ...
                    <div className="main-body">
                        <div className="box shadow-sm">
                            ...
                            <div className="add-project-section">
                                {
                                    viewOnly ? <div className="row"> <div className="col-2"> <button className='btn btn-dark px-5 ml-auto' onClick={() => navigate(`../project/${id}/update-task/${tid}`)}>Edit</button></div></div> :
